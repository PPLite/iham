!function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.Markov = e() : t.Markov = e()
    ...
    return function(t) {
        ...
        var n = function() {
            ...
            (n = [{
                key: "addStates",
                value: function(t) {
                    Array.isArray(t) ? this.states = Array.from(t) : this.states.push(t)
                }
            }, {
                key: "clearChain",
                value: function() {
                ...
                value: function() {
                    ...
                    "number" != typeof t && (console.error("Markov.setOrder: Order is not a number. Defaulting to 3."),
                    t = 3),
                    t <= 0 && console.error("Markov.setOrder: Order is not a positive number. Defaulting to 3."),
                    "numeric" === this.type && console.warn("The Markov Chain only accepts numerical data. Therefore, the order does not get used.\nThe order may be used by you to simulate an ID for the Markov Chain if required"),
                    this.order = t
                }
            }, {
                key: "getOrder",
                value: function() {
                    return "numeric" === this.type && console.warn("The Markov Chain only accepts numerical data. Therefore, the order does not get used.\nThe order may be used by you to simulate an ID for the Markov Chain if required"),
                    this.order
                }
            }, {
                ...
                value: function() {
                    ...
                    if ("text" === this.type) {
                        for (var e = this.random(this.start, "array"), r = e, i = e, o = "", n = 0; n < t - this.order && (o = this.random(this.possibilities[i], "array")); n++)
                    ...
                    if ("numeric" === this.type) {
                        for (var s = [], a = 0; a < t; ++a) {
                            ...
                            Math.random() < .5 ? s.push(parseInt(u)) : s.push(parseInt(this.predict(u)))
                        }
                        return s
                    }
                }
