      ...
      <form action="code.php" method="POST">
        ...
        <input type="hidden" name="id" id="id">
            ...
            <div class="form-group">
                ...
                <input type="text" name="rfid_uid" id="rfid_uid" class="form-control" disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="status_asset" class="form-control" id="status_asset" > 
                  <option value="tersedia"> Hadir </option>   
                  <option value="dipinjam"> Izin </option>
                  <option value="habis"> Keluar </option>
                </select>
             </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="code.php" method="POST">
        ...
        <input type="text" name="hapus_id_karyawan" id="hapus_id_karyawan">
