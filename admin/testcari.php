...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <button type="submit" name="hapushasilscan1" class="btn btn-primary">
              Hapus Semua Data Scan Reader 1 
            </button>
    
            <button type="submit" name="hapushasilscan2" class="btn btn-primary">
...
<!---Buat ngambil data--->
    ...
    $query = "SELECT * FROM tb_scanner1_assetbarang"; 
...
<!---Buat ngambil data--->
    <?php
    //dari database, dipilih semua (bintang = semuanya) dari tabel "tb_rfid"
    $query = "SELECT * FROM tb_scanner1_assetbayi"; 
    $query_run = mysqli_query($connection, $query);
    ?>
...
<!---Buat ngambil data--->
    <?php
    //dari database, dipilih semua (bintang = semuanya) dari tabel "tb_rfid"
    $query = "SELECT * FROM tb_scanner2_assetbarang"; 
    $query_run = mysqli_query($connection, $query);
    ?>
...
<!---Buat ngambil data--->
    <?php
    //dari database, dipilih semua (bintang = semuanya) dari tabel "tb_rfid"
    $query = "SELECT * FROM tb_scanner2_assetbayi"; 
    $query_run = mysqli_query($connection, $query);
    ?>
